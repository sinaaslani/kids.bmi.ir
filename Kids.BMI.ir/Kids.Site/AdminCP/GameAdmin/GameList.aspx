<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="True"
    CodeBehind="GameList.aspx.cs" Inherits="Site.Kids.bmi.ir.AdminCP.GameAdmin.GameList"
    Theme="Admin" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td align="center" width="100%">
                <div align="center">
                    <asp:GridView ID="dgGames" Height="30px" runat="server" AllowPaging="True" PageSize="20"
                        AutoGenerateColumns="False" CellPadding="2" Width="100%" GridLines="None" ForeColor="Black"
                        Font-Size="9pt" Font-Names="Tahoma" CellSpacing="1" OnPageIndexChanging="dgGames_PageIndexChanging">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="تصویر" >
                                <ItemTemplate>
                                    <asp:Image ID="Label1" Width=100 runat="server" ImageUrl='<%#SystemConfigs.UrlGameFilesPath+ Eval("ThumbnailAddress") %>'>
                                    </asp:Image>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" Width="120px" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="Name" HeaderText="نام بازی" HtmlEncode="False" HtmlEncodeFormatString="False">
        ...
        <tr>
            <td align="right" width="100%">
                <asp:HyperLink ID="lnkAdd" Text="ایجاد مورد جدید" runat="server" 
                    NavigateUrl="~/AdminCP/GameAdmin/GameAdmin.aspx"></asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
