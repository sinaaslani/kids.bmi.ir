...
namespace Kids.Utility.POP3
{
    ...
    public class Pop3MimeClient : Pop3MailClient
    {
        ...
        private readonly IFormatProvider culture = new CultureInfo("en-US", true);
        private readonly StringBuilder MimeEntitySB = new StringBuilder(100000);

        private bool isGetRawEmail;
        ...
        private MimeEntityReturnCode ProcessMimeEntity(RxMailMessage message, string parentBoundaryStart)
        {
            ...
            while (readMultiLine(out response))
            {
                ...
                if (isBoundaryDefined && response.TrimEnd() == BoundaryDelimiterLineStart)
                {
                    ...
                    return ProcessDelimitedBody(message, BoundaryDelimiterLineStart, parentBoundaryStart,
                                                parentBoundaryEnd);
                }
        ...
        /// </summary>
        private bool parentBoundaryFound(string response, string parentBoundaryStart, string parentBoundaryEnd,
            ...
            else
            {
                ...
                switch (headerLineType)
                {
                    ...
                    case "received":
                        ...
                        break;
                    //case "reply-to":
                    //    message.ReplyToList = ConvertToMailAddress(headerLineContent);
                    //    break;
                    case "return-path":
        ...
        private void AddChildPartsToParent(RxMailMessage child, RxMailMessage parent)
        {
            ...
            if (!string.IsNullOrEmpty(child.Body))
        ...
        #region Nested type: MimeEntityReturnCode
