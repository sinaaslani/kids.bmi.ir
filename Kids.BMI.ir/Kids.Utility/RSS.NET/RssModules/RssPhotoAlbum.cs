...
using Utility.RSS.NET.RSS;

namespace Utility.RSS.NET.RssModules
{
    ...
    public sealed class RssPhotoAlbumCategoryPhotoPeople : RssModuleItemCollection
    {
        ...
        {
            return Add(new RssModuleItem("person", true, value));
        }
    }
    ...
    public sealed class RssPhotoAlbumCategory : RssModuleItemCollection
    {
        ...
        public RssPhotoAlbumCategory(string categoryName, string categoryDescription, DateTime categoryDateFrom,
                                     DateTime categoryDateTo, RssPhotoAlbumCategoryPhoto categoryPhoto)
        {
        ...
        /// <param name="categoryPhotos">Photos of the category.</param>
        public RssPhotoAlbumCategory(string categoryName, string categoryDescription, string categoryDateFrom,
                                     string categoryDateTo, RssPhotoAlbumCategoryPhotos categoryPhotos)
        {
            Add(categoryName, categoryDescription, categoryDateFrom, categoryDateTo, categoryPhotos);
        }
    ...
    public sealed class RssPhotoAlbum : RssModule
    {
        ...
        public Uri Link
        {
            get
            {
                return (RssDefault.Check(ChannelExtensions[0].Text) == RssDefault.String)
                           ? null
                           : new Uri(base.ChannelExtensions[0].Text);
            }
