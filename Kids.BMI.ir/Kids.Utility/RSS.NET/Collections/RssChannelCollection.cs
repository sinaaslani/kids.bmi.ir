...
namespace Kids.Utility.RSS.NET.Collections
{
    ...
    public class RssChannelCollection : CollectionBase
    {
        ...
        public DSD.Site.UtilityClasses.RSS.NET.RssChannel.RssChannel this[int index]
        {
            get { return ((DSD.Site.UtilityClasses.RSS.NET.RssChannel.RssChannel) (List[index])); }
