...
namespace Kids.Utility.Csv
{
        ...
        : CsvReader
    {
            ...
            : IBindingList, ITypedList, IList<string[]>, IList
        {
            ...
            {
                _sort = (CachedCsvReader.CsvPropertyDescriptor) property;
                _direction = direction;

                _csv.ReadToEnd();

                _csv._records.Sort(new CachedCsvReader.CsvRecordComparer(_sort.Index, _direction));
            }
            ...
            {
                int fieldIndex = ((CachedCsvReader.CsvPropertyDescriptor) property).Index;
            ...
            public PropertyDescriptorCollection GetItemProperties(PropertyDescriptor[] listAccessors)
            {
                if (_properties == null)
                {
                    ...
                    for (int i = 0; i < properties.Length; i++)
                        properties[i] = new CachedCsvReader.CsvPropertyDescriptor(((System.Data.IDataReader) _csv).GetName(i), i);
