...
namespace Kids.Utility.Csv
{
        ...
        : CsvReader
    {
            ...
            : IComparer<string[]>
        {
            ...
            {
                if (field < 0)
                    throw new ArgumentOutOfRangeException("field", field, string.Format(CultureInfo.InvariantCulture, LumenWorks.Framework.IO.Csv.Resources.ExceptionMessage.FieldIndexOutOfRange, field));
