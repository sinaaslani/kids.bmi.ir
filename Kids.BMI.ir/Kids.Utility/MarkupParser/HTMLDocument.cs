...
namespace Kids.Utility.MarkupParser
{
    /// <summary>
    ...
    public class HTMLDocument : MarkupDocument
    {
        ...
        private HTMLDocument(string htmlText) : base(htmlText, true, (htmlText.Length > CACHE_BOUNDARY ? true : false), true) { }
        ...
        {
            HTMLDocument doc = new HTMLDocument(htmlText);
